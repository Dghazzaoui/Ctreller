...
# Add the categories
INSERT INTO categories (cat_name, boss_id) VALUES ('Books', 27); 
INSERT INTO categories (cat_name, boss_id) VALUES ('Computing', 58);
INSERT INTO categories (cat_name, boss_id) VALUES ('Toys', 62);
INSERT INTO categories (cat_name, boss_id) VALUES ('Gardening', 63);
INSERT INTO categories (cat_name, boss_id) VALUES ('Electronics', 58);
INSERT INTO categories (cat_name, boss_id) VALUES ('Clothes', 63);
INSERT INTO categories (cat_name, boss_id) VALUES ('Mens', 63);
INSERT INTO categories (cat_name, boss_id) VALUES ('Womens', 63);
INSERT INTO categories (cat_name, boss_id) VALUES ('Children', 63);
INSERT INTO categories (cat_name, boss_id) VALUES ('Sports & outdoors', 71);
INSERT INTO categories (cat_name, boss_id) VALUES ('Films', 27);

# Add cat_id column to staff
ALTER TABLE staff ADD column cat_id mediumint(8) unsigned;
# Put staff in categories
UPDATE staff SET cat_id = 1 WHERE id = 27;
UPDATE staff SET cat_id = 2 WHERE id = 58;
UPDATE staff SET cat_id = 3 WHERE id = 62;
UPDATE staff SET cat_id = 4 WHERE id = 63;
UPDATE staff SET cat_id = 5 WHERE id = 58;
UPDATE staff SET cat_id = 6 WHERE id = 63;
UPDATE staff SET cat_id = 7 WHERE id = 63;
UPDATE staff SET cat_id = 8 WHERE id = 63;
UPDATE staff SET cat_id = 9 WHERE id = 63;
UPDATE staff SET cat_id = 10 WHERE id = 71;
UPDATE staff SET cat_id = 11 WHERE id = 27;
...
INSERT INTO `products` (`product_name`,`description`,`cost`,`RRP`) VALUES ("Gardening month by month","How to have a beautiful garden",65,130);
INSERT INTO `products` (`product_name`,`description`,`cost`,`RRP`) VALUES ("Draper Expert 19655 Stainless Steel","How to have a beautiful garden from January to December now fully up-to-date and",70,180);
INSERT INTO `products` (`product_name`,`description`,`cost`,`RRP`) VALUES ("month by month","beautiful garden",20,50);
INSERT INTO `products` (`product_name`,`description`,`cost`,`RRP`) VALUES ("day by day","up to date",70,120);
INSERT INTO `products` (`product_name`,`description`,`cost`,`RRP`) VALUES ("days","up to date",70,120);
...
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Burke", "Santiago","metus.In@temporlorem.com","HPW87SDS3MZ","357-5726 Lacus Rd.","Montoggio","EJ6 4DR","1-618-902-3557");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Eric", "Meyer","Pellentesque.habitant@nunc.co.uk","NXV81MXZ0TT","P.O. Box 287, 4188 Mattis Rd.","Winnipeg","86042","1-858-410-4872");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Gregory", "Frank","purus.accumsan.interdum@anteVivamus.org","UVR24BQX6OC","8953 Eu St.","Oyen","4919","538-7402");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Merritt", "Roberson","pede.et@nislelementumpurus.co.uk","LTK61TKS5OO","P.O. Box 391, 8796 Sed Av.","Sheffield","NR9 4EU","1-235-120-0130");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Elliott", "Garcia","libero.Proin@mifelis.ca","QSS73WWD6PD","175-9530 Vitae, Av.","Saint John","2929HB","1-913-846-2954");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Lucius", "Donovan","tempor@etcommodo.edu","KIU88KIG2KV","826-1379 Erat. Avenue","Saint-Pierre","8013","1-648-158-9552");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Jesse", "Adkins","Integer@Praesentinterdum.net","FDT60VWA6KP","Ap #799-4156 Maecenas Ave","Saguenay","YT0Q 9DF","327-5290");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Stewart", "Conner","dis.parturient@vulputateeuodio.ca","BNQ10DXC9WD","4667 Molestie Avenue","Vigo","65424","635-3578");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Beck", "Gibbs","tortor.Nunc.commodo@ridiculusmusAenean.edu","IWS53YGU2BQ","373-6713 Libero Av.","Oudenaken","61716","1-107-254-1489");
INSERT INTO users (firstname,lastname,username,password,street_address,city,postcode,telephone_number) VALUES ("Otto", "Cantu","Suspendisse@facilisismagnatellus.edu","WSJ26FPU2EN","Ap #798-1459 Aliquet. St.","Bevagna","10015","1-115-175-4809");
...
INSERT INTO shopping_cart (user_id, product_id, quantity) VALUES (1,1, 3);
INSERT INTO shopping_cart (user_id, product_id, quantity) VALUES (1,2, 5);
INSERT INTO shopping_cart (user_id, product_id, quantity) VALUES (1,3, 2);
INSERT INTO shopping_cart (user_id, product_id, quantity) VALUES (2, 2 , 5);
INSERT INTO shopping_cart (user_id, product_id, quantity) VALUES (3,4, 7);
INSERT INTO shopping_cart (user_id, product_id, quantity) VALUES (4,3, 10);
